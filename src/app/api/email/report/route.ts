...
function generateEmailContent(user: any, session: any) {
    ...
    const styles = {
        ...
        headerSubtitle: "color: rgba(255,255,255,0.9); margin: 8px 0 0; font-size: 16px;",
        ...
        badge: "display: inline-block; padding: 4px 12px; border-radius: 9999px; font-size: 12px; font-weight: 500; background-color: #f1f5f9; color: #475569; margin-right: 8px;",
        scoreRow: "display: flex; justify-content: space-between; align-items: center; padding: 12px 0; border-bottom: 1px solid #f1f5f9;",
        ...
        <div style="${styles.container}">
            ...
            <div style="${styles.section}">
                ...
                <ul style="${styles.list}">
                    ${primaryInterp.strengths.slice(0, 4).map(s => `
                ...
                <ul style="${styles.list}">
                    ${primaryInterp.developmentAreas.slice(0, 3).map(d => `
                        <li style="${styles.listItem}">
