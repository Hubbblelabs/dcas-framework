  ...
  const handleSaveUser = async (updatedUser: User) => {
    try {
      ...
      if (res.ok) {
        ...
        setUsers(users.map((u) => (u._id === saved._id ? saved : u)));
        setIsEditOpen(false);
        setEditingUser(null);
      } else {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Cohorts & Users</h1>
          <p className="text-muted-foreground">
            Manage students and their cohort information
          </p>
        </div>
      </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Unique Batches</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Manage registered users and their cohort details
              </CardDescription>
            </div>
                  ...
                  <TableBody>
                    {filteredUsers.map((u) => (
                      <TableRow key={u._id}>
                        ...
                        <TableCell>
                          {u.batch ? (
                            <Badge variant="outline">{u.batch}</Badge>
                          ) : (
