    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          ...
          {studentName && (
            <Text style={{ fontSize: 14, marginTop: 5, color: "#475569" }}>
              Name: {studentName}
            </Text>
          )}
          ...
          <View style={styles.row}>
            {[
              ...
              <View key={type} style={styles.scoreCard}>
                ...
                <Text
                  style={{ fontSize: 12, fontWeight: "bold", color: "#0f172a" }}
                >
                  {dcasNames[type]}
                </Text>
                <Text
            ...
            {["D", "C", "A", "S"].map((type) => {
              ...
              return (
                ...
                >
                  ...
                  {/* X Axis Label */}
                  <Text
                    style={{ fontSize: 10, marginTop: 4, fontWeight: "bold" }}
                  >
                    {type}
                  </Text>
                </View>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>
            4. Communication & Stress Patterns
          </Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={{ ...styles.text, marginBottom: 10 }}>
            While your DCAS profile highlights many strengths, focusing on these
            development areas will help you become more well-rounded.
          </Text>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <View
            style={{ backgroundColor: "#f0f9ff", padding: 15, borderRadius: 8 }}
          >
            {[
              {
                num: 1,
