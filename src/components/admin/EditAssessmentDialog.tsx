...
export function EditAssessmentDialog({
  ...
  useEffect(() => {
    if (open && assessment) {
      ...
      setShuffleQuestions(assessment.settings?.shuffle_questions || false);
    }
  }, [open, assessment]);
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        <SheetHeader className="bg-muted/10 border-b p-6">
          ...
          <SheetDescription>
            Update assessment settings and select questions.
          </SheetDescription>
        </SheetHeader>
        <div className="flex-1 space-y-6 overflow-y-auto p-6">
          ...
          <div className="bg-card space-y-3 rounded-lg border p-4">
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="edit-manual">Manually Select Questions</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="random" id="edit-random" />
                <Label htmlFor="edit-random">
          ...
          {selectionMethod === "random" && (
            <div className="bg-muted/20 grid gap-2 rounded-lg border p-4">
              <Label htmlFor="edit-questionCount">
          ...
          <div className="bg-muted/50 flex items-center justify-between rounded-lg border p-3">
            <div>
              <Label htmlFor="edit-isLive" className="text-sm font-medium">
