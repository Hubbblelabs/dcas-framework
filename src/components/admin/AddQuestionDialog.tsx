    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new DCAS assessment question with 4 answer options.
          </DialogDescription>
        </DialogHeader>
        <div className="grid gap-4 py-4">
          ...
          <div className="space-y-3">
            ...
            {options.map((option, index) => (
              <div
                key={option.label}
                className="grid grid-cols-[60px_1fr_100px] items-center gap-2"
              >
                <div className="bg-muted flex h-10 items-center justify-center rounded-lg font-semibold">
                  {option.label}
                </div>
                <Input
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    handleOptionChange(index, "dcas_type", val)
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
            ...
            <p className="text-muted-foreground text-xs">
              Each option should map to a DCAS behavioural type.
            </p>
          </div>
        </div>
        <div className="bg-muted/50 mt-4 flex items-center justify-between rounded-lg border p-3">
          <div>
            ...
            <p className="text-muted-foreground text-xs">
              Inactive questions won&apos;t be used in random assessments.
            </p>
          </div>
          <Switch
            id="isActive"
